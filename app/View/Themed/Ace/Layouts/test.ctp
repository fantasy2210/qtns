...
<html lang="en">
    <head>
        ...
        <?php echo $this->Html->script('chosen') ?>
    ...
    <![endif]-->
        ...
        <script type="text/javascript">
            window.jQuery || document.write("<script src='/knm/js/jquery.min.js'>" + "<" + "/script>");
        </script>
        ...
        <!--[if IE]>
    <script type="text/javascript">
    window.jQuery || document.write("<script src='/knm/js/jquery1x.min.js'>"+"<"+"/script>");
    </script>
    <![endif]-->
        <script type="text/javascript">
            if ('ontouchstart' in document.documentElement)
                document.write("<script src='/knm/js/jquery.mobile.custom.min.js'>" + "<" + "/script>");
        </script>
