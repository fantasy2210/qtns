<div class="qdSapnhaps form">

    <div class="row">		
        <div class="col-md-12">		
            <div class="panel panel-default">
                <div class="panel-heading"><?php echo __('Edit Qd Sapnhap'); ?></div>
                <div class="panel-body">
                    			<?php echo $this->Form->create('QdSapnhap', array('role' => 'form','formStyle' => 'horizontal2')); ?>
					...
					<?php echo $this->Form->input('donvi1_id', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('donvi2_id', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('donvi_moi_id', array('class' => 'form-control'));?>
