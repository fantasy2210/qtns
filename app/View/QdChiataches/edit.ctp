<div class="qdChiataches form">

    <div class="row">		
        <div class="col-md-12">		
            <div class="panel panel-default">
                <div class="panel-heading"><?php echo __('Edit Qd Chiatach'); ?></div>
                <div class="panel-body">
                    			<?php echo $this->Form->create('QdChiatach', array('role' => 'form','formStyle' => 'horizontal2')); ?>
					...
					<?php echo $this->Form->input('donvi_moi_1_id', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('donvi_moi_2_id', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('donvi_cu_id', array('class' => 'form-control'));?>
