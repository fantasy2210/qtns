...
function UsermgmtInIt(&$controller) {
    ...
    /*
      Nếu cần gửi mail chào mừng sau khi đăng ký thì set true
     */
    ...
    if (!defined("EMAIL_FROM_NAME")) {
        define("EMAIL_FROM_NAME", 'Bảo Châu Computer');
    }
    ...
    if (!defined("LOGIN_REDIRECT_URL")) {
        define("LOGIN_REDIRECT_URL", '/users/home');
    }
