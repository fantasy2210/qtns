"ace"in window || (window.ace = {}), "helper"in window.ace || (window.ace.helper = {}), "options"in window.ace || (window.ace.options = {}), "vars"in window.ace || (window.ace.vars = {icon: " ace-icon ", ".icon": ".ace-icon"}), ace.vars.touch = "ontouchstart"in document.documentElement, jQuery(function(e) {
    ...
    var i = {general_vars: null, add_touch_drag: null, general_things: null, handle_side_menu: null, sidebar_scrollable: {scroll_to_active: !0, include_shortcuts: !0, include_toggle: !1 || ace.vars.safari || ace.vars.ios_safari, smooth_scroll: 200, outside: !1}, sidebar_hoverable: {sub_scroll: !1}, widget_boxes: null, widget_reload_handler: null, settings_box: null, settings_rtl: null, settings_skin: null, enable_searchbox_autocomplete: null, auto_hide_sidebar: !1, auto_padding: !1, auto_container: !1};
    ...
    var a = "menu-min", t = "responsive-min", i = "h-sidebar", s = e("#sidebar").eq(0);
    ace.vars.mobile_style = 1, s.hasClass("responsive") && !e("#menu-toggler").hasClass("navbar-toggle") ? ace.vars.mobile_style = 2 : s.hasClass(t) ? ace.vars.mobile_style = 3 : s.hasClass("navbar-collapse") && (ace.vars.mobile_style = 4), e(window).on("http://responsiweb.com/themes/preview/ace/1.3.1/assets/js/resize.ace.vars", function() {
        ...
        ace.vars.minimized = !ace.vars.collapsible &&
                s.hasClass(a) || 3 == ace.vars.mobile_style &&
                ace.vars.mobile_view && s.hasClass(t),
    ...
    }), e(document).on("", '.dropdown-toggle[data-position="auto"]', function() {
    ...
    if (t.length > 0) {
        ...
        e(window).on("scroll.scroll_btn", function() {
            var e = ace.helper.scrollTop(), a = ace.helper.winHeight(), s = document.body.scrollHeight;
    ...
    if (ace.vars.touch) {
        var a = "touchstart MSPointerDown pointerdown", t = "touchend touchcancel MSPointerUp MSPointerCancel pointerup pointercancel", i = "touchmove MSPointerMove MSPointerHover pointermove";
                ...
                n.on(a, function(a) {
                    function r(e) {
                        if (c) {
                            ...
                            if (o = {coords: [a.pageX, a.pageY]}, c && o && (u = 0, h = 0, d = Math.abs(h = c.coords[1] - o.coords[1]) > s && Math.abs(u = c.coords[0] - o.coords[0]) <= Math.abs(h) ? h > 0 ? "up" : "down" : Math.abs(u = c.coords[0] - o.coords[0]) > s && Math.abs(h) <= Math.abs(u) ? u > 0 ? "left" : "right" : !1, d !== !1)) {
                                var t = {cancel: !1};
                                c.origin.trigger({type: "ace_drag", direction: d, dx: u, dy: h, retval: t}), 0 == t.cancel && e.preventDefault()
                            }
                            c.coords[0] = o.coords[0], c.coords[1] = o.coords[1]
                        }
                    }
                    var o, l = a.originalEvent.touches ? a.originalEvent.touches[0] : a, c = {coords: [l.pageX, l.pageY], origin: e(a.target)}, d = !1, u = 0, h = 0;
    ...
    e(document).on(ace.click_event + ".ace.menu", "#menu-toggler", function() {
        ...
        var t = e(this).find(ace.vars[".icon"]), i = t.attr("data-icon1"), s = t.attr("data-icon2");
        a.hasClass("responsive-min") ? (t.removeClass(i).addClass(s), a.removeClass("responsive-min"), a.addClass("display responsive-max"), ace.vars.minimized = !1) : (t.removeClass(s).addClass(i), a.removeClass("display responsive-max"), a.addClass("responsive-min"), ace.vars.minimized = !0), e(document).triggerHandler("http://responsiweb.com/themes/preview/ace/1.3.1/assets/js/settings.ace", ["sidebar_collapsed", ace.vars.minimized])
    });
    var t = ace.vars.ios_safari;
    e(document).on(ace.click_event + ".ace.submenu", ".sidebar .nav-list", function(a) {
        //alert(1);
        var i = this, s = e(a.target).closest("a");
        if (s && 0 != s.length) {
            ...
            if (s.hasClass("dropdown-toggle")) {
                ...
                if (n && c == i || e(r.parentNode).hasClass("hover") && "absolute" == e(r).css("position") && !ace.vars.collapsible)
            ...
            if ("tap" == ace.click_event && n && s.get(0).parentNode.parentNode == i) {
                ...
                if (a.target != u && !e.contains(u, a.target))
                    return a.preventDefault(), !1
            }
            if (t && "false" !== s.attr("data-link"))
                return document.location = s.attr("href"), a.preventDefault(), !1
        }
    })
    ...
    function t(a, t, n) {
        var r;
        if (e(document).trigger(r = e.Event("ajaxloadstart"), {url: a, hash: t}), !r.isDefaultPrevented()) {
            var v = e(".page-content-area");
            v.css("opacity", .25);
            var p = e('<div style="position: fixed; z-index: 2000;" class="ajax-loading-overlay"><i class="ajax-loading-icon fa fa-spin ' + o + '"></i> ' + l + "</div>").insertBefore(v), f = v.offset();
            p.css({top: f.top, left: f.left}), e.ajax({url: a}).complete(function() {
                v.css("opacity", .8), e(document).on("ajaxscriptsloaded", function() {
                    v.css("opacity", 1), v.prevAll(".ajax-loading-overlay").remove()
                })
            }).error(function() {
                e(document).trigger("ajaxloaderror", {url: a, hash: t})
            }).done(function(r) {
                e(document).trigger("ajaxloaddone", {url: a, hash: t});
                var o = e('a[data-url="' + t + '"]'), l = "";
                if (o.length > 0) {
                    var p = o.closest(".nav");
                ...
                r = String(r).replace(/<(title|link)([\s\>])/gi, '<div class="hidden ajax-append-$1"$2').replace(/<\/(title|link)\>/gi, "</div>"), v.empty().html(r), v.css("opacity", .6), setTimeout(function() {
                    ...
                    v.find(".ajax-append-link").each(function() {
                        var t = e(this);
                        if (t.attr("href")) {
                            var i = jQuery("<link />", {type: "text/css", rel: "stylesheet", "class": "ajax-stylesheet"});
                            a.length > 0 ? i.insertBefore(a) : i.appendTo("head"), i.attr("href", t.attr("href"))
                        }
                        t.remove()
                    })
                }, 10), d && s(l, v), n || e("html,body").animate({scrollTop: 0}, 250), e(document).trigger("ajaxloadcomplete", {url: a, hash: t})
            })
        }
    }
    function i(a) {
        var t = "", i = e(".breadcrumb");
        if (i.length > 0 && i.is(":visible")) {
            i.find("> li:not(:first-child)").remove();
            var s = 0;
            a.parents(".nav li").each(function() {
                var a = e(this).find("> a"), n = a.clone();
    ...
    function s(a, t) {
        ...
        if (i.length > 0)
            document.title = i.text(), i.remove();
        else if (a.length > 0) {
            var s = e.trim(String(document.title).replace(/^(.*)[\-]/, ""));
            s && (s = " - " + s), a = e.trim(a) + s
        }
    }
    var n = a.content_url || !1, r = a.default_url || !1, o = a.loading_icon || "fa-spinner fa-2x orange", l = a.loading_text || "", c = a.update_breadcrumbs || "undefined" == typeof a.update_breadcrumbs, d = a.update_title || "undefined" == typeof a.update_title, u = a.update_active || "undefined" == typeof a.update_active, h = a.close_active || "undefined" == typeof a.close_active;
    e(window).off("http://responsiweb.com/themes/preview/ace/1.3.1/assets/js/hashchange.ajax").on("http://responsiweb.com/themes/preview/ace/1.3.1/assets/js/hashchange.ajax", function(a, i) {
    ...
    }).trigger("http://responsiweb.com/themes/preview/ace/1.3.1/assets/js/hashchange.ajax", [!0]), r && "" == window.location.hash && (window.location.hash = r)
    ...
    jQuery.ajaxPrefilter("script", function(e) {
        ...
        ace.submenu = {
            show: function(e, a) {
                ...
                var t, i = window.jQuery, s = i(e);
                if (s.trigger(t = i.Event("show.ace.submenu")), t.isDefaultPrevented())
                    return!1;
                ...
                var n = function(e, a) {
                    e && e.stopPropagation(), s.css({"transition-property": "", "transition-duration": "", overflow: "", height: ""}), ace.vars.transition && s.off(".trans"), a !== !1 && s.trigger(i.Event("shown.ace.submenu"))
                };
            ...
            hide: function(e, a) {
                var t, i = window.jQuery, s = i(e);
                if (s.trigger(t = i.Event("hide.ace.submenu")), t.isDefaultPrevented())
                    return!1;
                ...
                var n = function(e, a) {
                    e && e.stopPropagation(), s.css({display: "none", overflow: "", height: "", "transition-property": "", "transition-duration": ""}).removeClass("nav-show").addClass("nav-hide"), ace.vars.transition && s.off(".trans"), a !== !1 && s.trigger(i.Event("hidden.ace.submenu"))
                };
                return a > 0 && ace.vars.transition ? s.one("transitionend.trans webkitTransitionEnd.trans mozTransitionEnd.trans oTransitionEnd.trans", n) : n(), ace.vars.android && setTimeout(function() {
                    n(null, !1)
                }, a + 20), !0
                ...
                if (0 == e.scrollHeight) {
                    if (ace.submenu.show(e, a))
                        return 1
                } else if (ace.submenu.hide(e, a))
                    return-1;
                return 0
            }
        }, ace.sidebar_scrollable = function(e, a) {
    if (e.fn.ace_scroll) {
        var t = ace.vars.safari && navigator.userAgent.match(/version\/[1-5]/i), i = e(".sidebar"), s = (e(".navbar"), i.find(".nav-list")), n = i.find(".sidebar-toggle"), r = i.find(".sidebar-shortcuts"), o = e(window), l = i.get(0), c = s.get(0);
        if (l && c) {
            var d, u, h = null, v = null, p = null, f = null, g = null, m = !1, b = !1, w = a.scroll_to_active || !1, _ = a.include_shortcuts || !1, y = a.include_toggle || !1, C = a.smooth_scroll || !1, x = a.outside || !1, k = "getComputedStyle"in window ? function() {
                return l.offsetHeight, "fixed" == window.getComputedStyle(l).position
            } : function() {
                return l.offsetHeight, "fixed" == i.css("position")
            }, T = k(), j = i.hasClass("h-sidebar"), H = ace.helper.sidebar_scroll = {available_height: function() {
                    ...
                    if (!b && T) {
                        s.wrap('<div style="position: relative;" />'), s.after("<div><div></div></div>"), s.wrap('<div class="nav-wrap" />'), y || n.css({"z-index": 1}), _ || r.css({"z-index": 99}), h = s.parent().next().ace_scroll({size: H.available_height(), reset: !0, mouseWheelLock: !0, hoverReset: !1, dragEvent: !0, touchDrag: !1}).closest(".ace-scroll").addClass("nav-scroll"), g = h.data("ace_scroll"), v = h.find(".scroll-content").eq(0), p = v.find(" > div").eq(0), f = h.find(".scroll-bar").eq(0), _ && (s.parent().prepend(r).wrapInner("<div />"), s = s.parent()), y && (s.append(n), s.closest(".nav-wrap").addClass("nav-wrap-t")), s.css({position: "relative"}), x === !0 && h.addClass("scrollout"), c = s.get(0), c.style.top = 0, v.on("http://responsiweb.com/themes/preview/ace/1.3.1/assets/js/scroll.nav", function() {
                        ...
                        }).on("touchcancel.nav MSPointerUp.nav MSPointerCancel.nav pointerup.nav pointercancel.nav", function() {
                        ...
                        if (b = !0, 1 == a && (H.reset(), w && H.scroll_to_active(), w = !1), "number" == typeof C && C > 0 && (s.css({"transition-property": "top", "transition-duration": (C / 1e3).toFixed(2) + "s"}), f.css({"transition-property": "top", "transition-duration": (C / 1500).toFixed(2) + "s"}), h.on("drag.start", function(e) {
                    ...
                    if (g && g.is_active())
                        try {
                            ...
                            var t = e.outerHeight();
                            a = a.get(0);
                            for (var n = e.get(0); n != a; )
                                t += n.offsetTop, n = n.parentNode;
                            var r = t - h.height();
                    ...
                    if (!T)
                        return void H.disable();
                    b || H.initiate();
                    var e = !ace.vars.collapsible && (!j || j && ace.vars.mobile_view) && (d = H.available_height()) < (u = c.scrollHeight);
                    m = !0, e && (p.css({height: u, width: 8}), h.prev().css({"max-height": d}), g.update({size: d}).enable().reset()), e && g.is_active() ? i.addClass("sidebar-scroll") : m && H.disable()
                }, disable: function() {
                    m = !1, h && (h.css({height: "", "max-height": ""}), p.css({height: "", width: ""}), h.prev().css({"max-height": ""}), g.disable()), parseInt(c.style.top) < 0 && C && ace.vars.transition ? s.one("transitionend.trans webkitTransitionEnd.trans mozTransitionEnd.trans oTransitionEnd.trans", function() {
                        i.removeClass("sidebar-scroll"), s.off(".trans")
                    }) : i.removeClass("sidebar-scroll"), c.style.top = 0
                }, prehide: function(e) {
                    if (m && !ace.vars.minimized)
                        if (H.content_height() + e < H.available_height())
                            H.disable();
                        else if (0 > e) {
                            var a = v.scrollTop() + e;
                            if (0 > a)
    ...
    function t(a) {
        ...
        var n = t.offset(), r = ace.helper.scrollTop(), o = !1, c = r;
        d && (c += l.clientHeight + 1);
        var h = a.scrollHeight;
        s && (h += 40, n.top -= 40);
        var v, p = parseInt(n.top + h), f = window.innerHeight;
        if ((v = p - (f + r - 50)) > 0)
            if (u > h - v && n.top - v > c)
        ...
        if (o) {
            if (-1 == m && (this.className = this.className + " pull_up"), i) {
                var b = h + n.top - v;
                0 > f - b ? e(a).css({"max-height": h + f - b - 50, "overflow-x": "hidden", "overflow-y": "scroll"}).on("mousewheel.sub_scroll DOMMouseScroll.sub_scroll ace_drag.sub_scroll", function(e) {
                    e.stopPropagation()
                }) : e(a).css({"max-height": "", "overflow-x": "", "overflow-y": ""}).off("mousewheel.sub_scroll DOMMouseScroll.sub_scroll ace_drag.sub_scroll", function(e) {
                    e.stopPropagation()
                })
            }
        } else
            m >= 0 && (this.className = this.className.replace(/(^|\s)pull_up($|\s)/, " "));
    ...
    if ("querySelector"in document && "removeProperty"in document.documentElement.style) {
        ...
        var s = "getComputedStyle"in window ? function(e, a) {
            return e.offsetHeight, window.getComputedStyle(e).position == a
        } : function(a, t) {
        ...
        var n = e(".sidebar").eq(0), r = (n.get(0), n.find(".nav-list").get(0)), o = e(".navbar").eq(0), l = o.get(0), c = n.hasClass("h-sidebar"), d = "fixed" == o.css("position");
    ...
    var a = function(a) {
        ...
        this.reload = function() {
            ...
            var t = this.$box, i = t.find(".widget-body"), s = null, n = "undefined" != typeof e ? e : t.hasClass("collapsed") ? "show" : "hide", r = "show" == n ? "shown" : "hidden";
    ...
    e.fn.widget_box = function(t, i) {
        ...
        t.preventDefault();
        var i = e(this), s = i.closest(".widget-box");
        if (0 != s.length && !s.hasClass("ui-sortable-helper")) {
            ...
            if ("collapse" == r) {
                ...
                if (s.trigger(o = e.Event(l + ".ace.widget")), o.isDefaultPrevented())
                    return;
                n.toggle(l, i)
            } else if ("close" == r) {
                var o;
                if (s.trigger(o = e.Event("close.ace.widget")), o.isDefaultPrevented())
                    return;
                n.close()
            } else if ("reload" == r) {
                i.blur();
                var o;
                if (s.trigger(o = e.Event("reload.ace.widget")), o.isDefaultPrevented())
                    return;
                n.reload()
            } else if ("fullscreen" == r) {
                var o;
                if (s.trigger(o = e.Event("fullscreen.ace.widget")), o.isDefaultPrevented())
                    return;
                n.fullscreen()
            } else
                "settings" == r && s.trigger("setting.ace.widget")
        }
    })
    ...
    e("#ace-settings-btn").on(ace.click_event, function(a) {
        ...
        if (this.checked) {
            ...
            e("#sidebar").removeClass("compact"), "sidebar_scroll"in ace.helper && ace.helper.sidebar_scroll.reset()
    ...
    e("#skin-colorpicker").on("change", function() {
        ...
        if ("no-skin" == a) {
            ...
            e(".ace-nav > li").addClass("no-border margin-1"), e(".ace-nav > li:not(:last-child)").addClass("light-pink").find("> a > " + ace.vars[".icon"]).addClass("pink").end().eq(0).find(".badge").addClass("badge-warning"), e(".sidebar-shortcuts .btn").attr("class", "btn btn-white btn-pink").find(ace.vars[".icon"]).addClass("white");
        else if ("skin-3" == a) {
    ...
    try {
        e("#nav-search-input").bs_typeahead({source: ace.vars.US_STATES, updater: function(a) {
